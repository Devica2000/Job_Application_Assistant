...
#     leetcode_questions_plan
# )
# from utils import PDFReadTool, search_tool, search_tool_serp, scrape_tool, semantic_search_resume, pdf_tool
...
# github_url = st.text_input("GitHub URL")
# linkedin_url = st.text_input("LinkedIn URL")
# pdf_filepath = st.file_uploader("Upload Resume (PDF)", type="pdf")
# interested_field = st.text_input("Interested Field")
...
#             f.write(pdf_filepath.getbuffer())
#         pdf_filepath = "temp_resume.pdf"
...
#     with st.spinner("Processing your application..."):
#         result_linkedin = job_application_crew.kickoff(inputs=job_application_inputs)
#         result_leetcode = leetcode_crew.kickoff(inputs=job_application_inputs)
...
#     with open("interview_preparation.md", "r") as f:
#         st.markdown(f.read())

#     st.subheader("LinkedIn About Section")
#     with open("linkedin_about.md", "r") as f:
#         st.markdown(f.read())

#     st.subheader("LinkedIn Message")
#     with open("linkedin_message.md", "r") as f:
#         st.markdown(f.read())

#     st.subheader("Frequently Asked Questions")
#     with open("faq_questions.md", "r") as f:
#         st.markdown(f.read())

#     st.subheader("LeetCode Plan")
#     with open("leetcode_plan.md", "r") as f:
#         st.markdown(f.read())
